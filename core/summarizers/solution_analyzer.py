...
class SolutionAnalyzer(LLMNode):
    _template = (
        ...
        "Brief introduction \n"
        "## Solutions \n"
        "Solution title. The title begins with ### and is bold. \n"
        "Brief explanation why this solution solves the error message. \n"
        "Finally, provide the detailed step by step instructions how to solve the error message. Start with #### Instructions. "
        ...
        "No preample. Follow plain structure, no nested enumerated/unordered lists. \n\n"
        "<error_message>\n"
        "{error_message}\n"
        "</error_message>"
    )
